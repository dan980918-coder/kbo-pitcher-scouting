...
TARGET = "WAR_out"
FEATURES = ["FIP_in", "WHIP_in", "K9_in", "BB9_in", "IP_in"]
...
# ---------------------------------------------------------------------
print("\n" + "=" * 90)
print("2. Ridge (5변수, WAR_in/ball_era 제외 -- 외국인 신규투수에게 실제 대입 가능한 변수만)")
print("=" * 90)
...
res_df.to_csv(f"{ROOT}/reports/modeling/kbo_wide_model_comparison_transferable5.csv", index=False)
print(f"\n저장: {ROOT}/reports/modeling/kbo_wide_model_comparison_transferable5.csv")
